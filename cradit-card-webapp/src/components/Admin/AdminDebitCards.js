...
function AdminDebitCards() {
  ...
  const columns = [
    ...
    {
      header: 'Card category', field: (row) => {
  ...
  return (
    <div className="wrapper min-h-full px-0">
      <div className="flex items-center justify-start space-x-7 pt-9">
        <div className="w-1/4">
          <div className="bg-lightWhite border border-[#CBD5E1] py-7 px-11 rounded-xl">
            <h2 className="text-darkGreen mb-3">₹8000</h2>
            <span className="text-[#64748B] text-xl font-semibold whitespace-nowrap">Total Credit Balance</span>
          </div>
        </div>
        <div className="w-1/4">
          <div className="bg-lightWhite border border-[#CBD5E1] py-7 px-11 rounded-xl">
            <h2 className="text-yankeesBlue mb-3">₹54,000</h2>
