        ...
        <div className="wrapper min-h-full">
            <div className="flex items-center justify-between pb-11">
                <div className="flex items-center cursor-pointer">
                    ...
                    <h3 className="text-yankeesBlue leading-8 pl-7">Payment Request</h3>
                </div>
                <div className="flex space-x-3">
                    <button onClick={() => setPaymentDetailPopUp(true)} className="btn-secondary flex">Pay Now</button>
                </div>
            </div>
            <div className="bg-lightWhite rounded-xl py-6 px-12 mb-7">
                <div className="text-yankeesBlue text-2xl font-bold mb-6">Payment to</div>
            ...
            <Modal isOpen={paymentDetailPopUp}>
                <PaymentDetails handleClose={setPaymentDetailPopUp} />
            </Modal>
        </div>
    )
}
