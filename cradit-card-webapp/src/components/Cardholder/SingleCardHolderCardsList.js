...
function SingleCardHolderCardsList() {
	return (
		<div className="wrapper min-h-full">
			<div className="flex items-center justify-between">
				<div className="flex items-center">
					...
					<h3 className="text-yankeesBlue leading-8 pl-7">Olivia Smith</h3>
				</div>
				<Link to="../addcardholdercard" className="btn-secondary flex">
...
export default SingleCardHolderCardsList