				...
				<form>
					<div className="w-full">
						<div className="w-full flex items-center space-x-6 mb-7">
							...
							<div className='w-1/2'>
								<label htmlFor="" className="input-title2">Card category</label>
						...
						<div className="w-full flex space-x-6 mb-7">
							...
							<div className='w-1/2'>
								<label htmlFor="" className="input-title2">Available balance *</label>
...
export default CardHolderAddCard